...
#==========================================#
#------------------TROPHY------------------#
scoreboard players set #Trophy_brew_potion Temp 1
tellraw @a ["",{"text":"---------------------------------------------","bold":true,"color":"gold"},"\n",{"selector":"@s"}," has obtained the ",{"text":"First to brew a Potion","color":"green"}," Trophy!","\n","GG!","\n",{"text":"---------------------------------------------","bold":true,"color":"gold"}]
...
loot give @s loot bcsmp:trophies/brew_potion
execute store success score #Calc Temp run clear @s player_head{Trophy_brew_potion:1b} 0
execute unless score #Calc Temp matches 1 run loot spawn ~ ~1.62 ~ loot bcsmp:trophies/brew_potion
advancement grant @a only bcsmp:trophy_page/nether/brew_potion
#------------------------------------------#
