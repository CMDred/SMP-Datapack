...
#==========================================#
#------------------TROPHY------------------#
scoreboard players set #Trophy_bullseye Temp 1
tellraw @a ["",{"text":"---------------------------------------------","bold":true,"color":"gold"},"\n",{"selector":"@s"}," has obtained the ",{"text":"First to hit a Bullseye from 30m away","color":"green"}," Trophy!","\n","GG!","\n",{"text":"---------------------------------------------","bold":true,"color":"gold"}]
...
loot give @s loot bcsmp:trophies/bullseye
execute store success score #Calc Temp run clear @s player_head{Trophy_bullseye:1b} 0
execute unless score #Calc Temp matches 1 run loot spawn ~ ~1.62 ~ loot bcsmp:trophies/bullseye
advancement grant @a only bcsmp:trophy_page/adventure/bullseye
#------------------------------------------#
