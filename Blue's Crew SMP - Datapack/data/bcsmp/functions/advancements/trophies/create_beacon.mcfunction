...
#==========================================#
#------------------TROPHY------------------#
scoreboard players set #Trophy_create_beacon Temp 1
tellraw @a ["",{"text":"---------------------------------------------","bold":true,"color":"gold"},"\n",{"selector":"@s"}," has obtained the ",{"text":"First to create a Beacon","color":"green"}," Trophy!","\n","GG!","\n",{"text":"---------------------------------------------","bold":true,"color":"gold"}]
...
loot give @s loot bcsmp:trophies/create_beacon
execute store success score #Calc Temp run clear @s player_head{Trophy_create_beacon:1b} 0
execute unless score #Calc Temp matches 1 run loot spawn ~ ~1.62 ~ loot bcsmp:trophies/create_beacon
advancement grant @a only bcsmp:trophy_page/nether/create_beacon
#------------------------------------------#
