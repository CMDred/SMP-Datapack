...
#==========================================#
#------------------TROPHY------------------#
scoreboard players set #Trophy_find_bastion Temp 1
tellraw @a ["",{"text":"---------------------------------------------","bold":true,"color":"gold"},"\n",{"selector":"@s"}," has obtained the ",{"text":"First to find a Piglin Bastion","color":"green"}," Trophy!","\n","GG!","\n",{"text":"---------------------------------------------","bold":true,"color":"gold"}]
...
loot give @s loot bcsmp:trophies/find_bastion
execute store success score #Calc Temp run clear @s player_head{Trophy_find_bastion:1b} 0
execute unless score #Calc Temp matches 1 run loot spawn ~ ~1.62 ~ loot bcsmp:trophies/find_bastion
advancement grant @a only bcsmp:trophy_page/nether/find_bastion
#------------------------------------------#
