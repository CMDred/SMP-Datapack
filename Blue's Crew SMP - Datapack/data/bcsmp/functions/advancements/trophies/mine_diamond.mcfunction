...
#==========================================#
#------------------TROPHY------------------#
scoreboard players set #Trophy_mine_diamond Temp 1
tellraw @a ["",{"text":"---------------------------------------------","bold":true,"color":"gold"},"\n",{"selector":"@s"}," has obtained the ",{"text":"First to mine Diamonds","color":"green"}," Trophy!","\n","GG!","\n",{"text":"---------------------------------------------","bold":true,"color":"gold"}]
...
loot give @s loot bcsmp:trophies/mine_diamond
execute store success score #Calc Temp run clear @s player_head{Trophy_mine_diamond:1b} 0
execute unless score #Calc Temp matches 1 run loot spawn ~ ~1.62 ~ loot bcsmp:trophies/mine_diamond
advancement grant @a only bcsmp:trophy_page/story/mine_diamond
#------------------------------------------#
