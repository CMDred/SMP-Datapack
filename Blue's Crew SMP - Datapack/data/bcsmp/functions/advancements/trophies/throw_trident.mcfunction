...
#==========================================#
#------------------TROPHY------------------#
scoreboard players set #Trophy_throw_trident Temp 1
tellraw @a ["",{"text":"---------------------------------------------","bold":true,"color":"gold"},"\n",{"selector":"@s"}," has obtained the ",{"text":"First to throw a Trident","color":"green"}," Trophy!","\n","GG!","\n",{"text":"---------------------------------------------","bold":true,"color":"gold"}]
...
loot give @s loot bcsmp:trophies/throw_trident
execute store success score #Calc Temp run clear @s player_head{Trophy_throw_trident:1b} 0
execute unless score #Calc Temp matches 1 run loot spawn ~ ~1.62 ~ loot bcsmp:trophies/throw_trident
advancement grant @a only bcsmp:trophy_page/adventure/throw_trident
#------------------------------------------#
