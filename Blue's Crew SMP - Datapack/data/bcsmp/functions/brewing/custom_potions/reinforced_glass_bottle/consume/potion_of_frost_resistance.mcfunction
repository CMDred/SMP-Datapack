...
#==========================================#
#-----------------CONSUME------------------#
advancement revoke @s only bcsmp:brewing/consume_potion_of_frost_resistance
tag @s[gamemode=!creative] add ConsumedItem
execute store success score @s ConsumeItem if predicate bcsmp:brewing/holding_potion_of_frost_resistance_mainhand
...
#------------------EFFECT------------------#
scoreboard players set @s FrostResistanceDuration 1200
#------------------------------------------#
