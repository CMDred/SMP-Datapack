...
execute store result score @s VillagerID run scoreboard players add #Global VillagerID 1
scoreboard players operation @e[type=villager,distance=..3,tag=!Converted] VillagerID = @s VillagerID
...
execute store result entity @s Offers.Recipes[1].sell.tag.MoveID int 1 run scoreboard players get @s VillagerID
execute store result entity @s Offers.Recipes[2].sell.tag.MoveID int 1 run scoreboard players get @s VillagerID
execute store result entity @s Offers.Recipes[3].sell.tag.MoveID int 1 run scoreboard players get @s VillagerID
