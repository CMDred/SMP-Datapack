...
execute as @e[tag=FactionPaper,distance=..1.5,limit=1] store result score #UUID0 Temp run data get entity @s Thrower[0]
execute as @e[tag=FactionPaper,distance=..1.5,limit=1] store result score #UUID1 Temp run data get entity @s Thrower[1]
...
data modify entity @e[tag=FactionCenter,sort=nearest,limit=1] data.Faction set from storage bcsmp:factions NewFaction
...
execute as @e[tag=FactionOutpostVillager,sort=nearest,limit=1] run function bcsmp:factions/villager/convert_to_faction_advisor
