...
execute anchored eyes positioned ^ ^ ^ facing entity @e[type=marker,tag=LaserTargetMarker,limit=1] feet run function bcsmp:mobs/ai/ender_dragon_fight/abilities/laser/raycast
kill @e[type=marker,tag=LaserTargetMarker]
#------------------------------------------#
