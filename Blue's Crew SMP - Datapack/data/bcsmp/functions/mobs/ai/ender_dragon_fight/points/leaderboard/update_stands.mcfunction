...
execute in overworld run data modify entity @e[type=armor_stand,tag=Line2,limit=1] CustomName set from block 29999977 1 29832 Text1
execute in overworld run data modify entity @e[type=armor_stand,tag=Line3,limit=1] CustomName set from block 29999977 1 29832 Text2
execute in overworld run data modify entity @e[type=armor_stand,tag=Line4,limit=1] CustomName set from block 29999977 1 29832 Text3
execute in overworld run data modify entity @e[type=armor_stand,tag=Line5,limit=1] CustomName set from block 29999977 1 29832 Text4
execute in overworld run data modify entity @e[type=armor_stand,tag=Line6,limit=1] CustomName set from block 29999977 1 29833 Text1
execute in overworld run data modify entity @e[type=armor_stand,tag=Line7,limit=1] CustomName set from block 29999977 1 29833 Text2
