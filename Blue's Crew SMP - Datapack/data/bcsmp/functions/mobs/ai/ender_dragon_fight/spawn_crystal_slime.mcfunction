...
#==========================================#
#---------------DRAGON FIGHT---------------#
tp @e[type=slime,tag=DestroyChecker,distance=..3] ~ ~-10 ~
...
effect give @e[type=slime,tag=DestroyChecker,distance=..5] invisibility 99999 255 true
tag @s add SlimeSpawned
execute unless entity @e[type=marker,tag=CrystalPlace,distance=..2] run summon marker ~ ~ ~ {Tags:["CrystalPlace"]}
#------------------------------------------#
