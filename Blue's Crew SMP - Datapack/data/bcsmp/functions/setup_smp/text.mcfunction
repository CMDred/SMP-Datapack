...
execute if score #BlocksAffectTemperature GameRules matches 1 run tellraw @s ["",{"text":"Blocks affect Temperature :","color":"dark_green"},{"text":" [TRUE]","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/blocks_affect_temperature/true"}},{"text":" [FALSE]","color":"gray","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/blocks_affect_temperature/false"}}]
execute if score #BlocksAffectTemperature GameRules matches 0 run tellraw @s [{"text":"Blocks affect Temperature :","color":"dark_green"},{"text":" [TRUE]","color": "gray","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/blocks_affect_temperature/true"}},{"text":" [FALSE]","bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/blocks_affect_temperature/false"}}]

execute if score #ShopPriceIncrease GameRules matches 1 run tellraw @s ["",{"text":"Shop Price increase if Faction Outsider :","color":"dark_green"},{"text":" [TRUE]","bold":true,"color":"green","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/shop_price_increase/true"}},{"text":" [FALSE]","color":"gray","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/shop_price_increase/false"}}]
execute if score #ShopPriceIncrease GameRules matches 0 run tellraw @s [{"text":"Shop Price increase if Faction Outsider :","color":"dark_green"},{"text":" [TRUE]","color": "gray","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/shop_price_increase/true"}},{"text":" [FALSE]","bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/function bcsmp:setup_smp/set_rules/shop_price_increase/false"}}]
#------------------------------------------#
