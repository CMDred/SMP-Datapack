...
execute at @s as @e[tag=Shop,distance=..20] if score @s ShopID = @e[tag=Container,sort=nearest,limit=1] ShopID run scoreboard players remove @s CurrentContainersAmount 1
kill @s
#------------------------------------------#