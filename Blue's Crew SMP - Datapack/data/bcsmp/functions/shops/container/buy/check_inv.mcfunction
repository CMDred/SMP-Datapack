...
execute if entity @e[type=marker,tag=ThisIncome] unless score #IncomeStorageSlots Temp matches 27.. in overworld run function bcsmp:shops/container/buy/start_cycle
