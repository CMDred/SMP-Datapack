...
execute at @e[type=marker,tag=ThisOutcome] run data modify storage bcsmp:shops PlayerInv set from block ~ ~ ~ Items
execute at @e[type=marker,tag=ThisOutcome] run data modify storage bcsmp:shops PriceItem set from storage bcsmp:shops SoldItem
