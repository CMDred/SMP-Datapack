...
#==========================================#
#------------------SHOPS-------------------#
data modify storage bcsmp:shops PriceItem set from entity @s data.Trades[2].buy
data modify storage bcsmp:shops SoldItem set from entity @s data.Trades[2].sell
