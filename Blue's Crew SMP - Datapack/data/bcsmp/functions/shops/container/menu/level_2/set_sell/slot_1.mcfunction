...
execute unless data storage bcsmp:shops SetItem.tag.display.Name run tellraw @a[scores={ContainerItems=1..},sort=nearest,limit=1] ["",{"text":"You have set ","color":"white"},{"selector":"@e[type=item,tag=NameGet,limit=1]","color":"yellow"},{"text":" x","color":"gray"},{"score":{"name":"#Count","objective": "Temp"},"color":"gray"},{"text":" as the sold item for the 1st slot!","color":"white"}]
execute if data storage bcsmp:shops SetItem.tag.display.Name run tellraw @a[scores={ContainerItems=1..},sort=nearest,limit=1] ["",{"text":"You have set ","color":"white"},{"nbt":"SetItem.tag.display.Name","interpret":true,"storage":"bcsmp:shops","color":"yellow"},{"text":" x","color":"gray"},{"score":{"name":"#Count","objective": "Temp"},"color":"gray"},{"text":" as the sold item for the 1st slot!","color":"white"}]
