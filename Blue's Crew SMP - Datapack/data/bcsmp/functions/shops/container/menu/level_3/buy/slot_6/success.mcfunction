...
#==========================================#
#------------------SHOPS-------------------#
data modify storage bcsmp:shops PriceItem set from entity @s data.Trades[5].buy
data modify storage bcsmp:shops SoldItem set from entity @s data.Trades[5].sell
