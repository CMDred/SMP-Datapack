...
#==========================================#
#------------------SHOPS-------------------#
execute if data block ~ ~ ~ Items[{Slot:0b}] unless data block ~ ~ ~ Items[{Slot:0b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_sell/slot_1
execute if data block ~ ~ ~ Items[{Slot:1b}] unless data block ~ ~ ~ Items[{Slot:1b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_sell/slot_2
execute if data block ~ ~ ~ Items[{Slot:3b}] unless data block ~ ~ ~ Items[{Slot:3b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_sell/slot_3
execute if data block ~ ~ ~ Items[{Slot:5b}] unless data block ~ ~ ~ Items[{Slot:5b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_sell/slot_4
execute if data block ~ ~ ~ Items[{Slot:7b}] unless data block ~ ~ ~ Items[{Slot:7b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_sell/slot_5
execute if data block ~ ~ ~ Items[{Slot:8b}] unless data block ~ ~ ~ Items[{Slot:8b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_sell/slot_6

execute if data block ~ ~ ~ Items[{Slot:18b}] unless data block ~ ~ ~ Items[{Slot:18b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_cost/slot_1
execute if data block ~ ~ ~ Items[{Slot:19b}] unless data block ~ ~ ~ Items[{Slot:19b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_cost/slot_2
execute if data block ~ ~ ~ Items[{Slot:21b}] unless data block ~ ~ ~ Items[{Slot:21b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_cost/slot_3
execute if data block ~ ~ ~ Items[{Slot:23b}] unless data block ~ ~ ~ Items[{Slot:23b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_cost/slot_4
execute if data block ~ ~ ~ Items[{Slot:25b}] unless data block ~ ~ ~ Items[{Slot:25b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_cost/slot_5
execute if data block ~ ~ ~ Items[{Slot:26b}] unless data block ~ ~ ~ Items[{Slot:26b}].tag.ContainerMenu run function bcsmp:shops/container/menu/level_3/set_cost/slot_6
...
execute if entity @s[tag=WorkingMode] unless data block ~ ~ ~ Items[{Slot:9b,tag:{ContainerMenu:1b}}] run function bcsmp:shops/container/menu/level_3/buy/slot_1
execute if entity @s[tag=WorkingMode] unless data block ~ ~ ~ Items[{Slot:10b,tag:{ContainerMenu:1b}}] run function bcsmp:shops/container/menu/level_3/buy/slot_2
execute if entity @s[tag=WorkingMode] unless data block ~ ~ ~ Items[{Slot:12b,tag:{ContainerMenu:1b}}] run function bcsmp:shops/container/menu/level_3/buy/slot_3
execute if entity @s[tag=WorkingMode] unless data block ~ ~ ~ Items[{Slot:14b,tag:{ContainerMenu:1b}}] run function bcsmp:shops/container/menu/level_3/buy/slot_4
execute if entity @s[tag=WorkingMode] unless data block ~ ~ ~ Items[{Slot:16b,tag:{ContainerMenu:1b}}] run function bcsmp:shops/container/menu/level_3/buy/slot_5
execute if entity @s[tag=WorkingMode] unless data block ~ ~ ~ Items[{Slot:17b,tag:{ContainerMenu:1b}}] run function bcsmp:shops/container/menu/level_3/buy/slot_6
