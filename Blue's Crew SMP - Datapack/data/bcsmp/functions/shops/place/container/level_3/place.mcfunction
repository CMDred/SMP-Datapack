...
tellraw @a[tag=Placing] [{"text":"You placed a ","color":"white"},{"text":"Level 3 Shop Container","color":"red"},{"text":"! ","color":"white"},{"text":"(","color":"gray"},{"score":{"name": "#CurrentContainersAmount","objective": "Temp"},"color":"gold"},{"text":"/","color":"gray"},{"score":{"name": "#ContainerLimit","objective": "Temp"},"color":"red"},{"text":")","color":"gray"}]
