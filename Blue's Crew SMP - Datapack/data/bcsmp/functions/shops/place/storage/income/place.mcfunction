...
tellraw @a[tag=Placing] [{"text":"You placed a ","color":"white"},{"text":"Shop Income Storage","color":"yellow"},{"text":"! ","color":"white"}]
particle dust 0.243 0.765 0.016 1 ~ ~ ~ 0.3 0.15 0.3 0.1 20 normal
summon marker ~ ~ ~ {Tags:["IncomeStorage","Storage","NewStorage"]}
setblock ~ ~ ~ barrel[facing=up]{CustomName:'{"text":"Shop Income"}'}
