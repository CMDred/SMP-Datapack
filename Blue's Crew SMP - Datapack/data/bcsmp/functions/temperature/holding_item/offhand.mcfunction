...
execute unless score #ItemFound Temp matches 1 if predicate bcsmp:temperature/holding_offhand/powder_snow_bottle run function bcsmp:temperature/holding_item/item/powder_snow_bottle
