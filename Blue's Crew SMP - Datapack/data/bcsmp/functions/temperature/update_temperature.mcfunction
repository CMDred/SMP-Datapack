...
execute if score @s ConsumedItemTimer matches 1.. run function bcsmp:temperature/consume_items/check
...
execute if score @s HeatResistanceDuration matches 1.. run scoreboard players add @s BurnTemperature 1500
#-------------FREEZE TEMPERATURE-------------#
