...
##
#-------------------POTIONS----------------#
execute if block ~ ~-1 ~ brewing_stand positioned ~ ~-1 ~ run function bcsmp:upgrade_potion
#lightning bolt's position is always one higher than the block it strikes
execute if block ~ ~-2 ~ brewing_stand positioned ~ ~-2 ~ run function bcsmp:upgrade_potion
