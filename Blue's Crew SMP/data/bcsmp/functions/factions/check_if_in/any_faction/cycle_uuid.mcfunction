...
scoreboard players remove #AmountOfUUIDInterations Temp 1
...
execute if score #IsDifferent Temp matches 1 if score #AmountOfUUIDInterations Temp matches 1.. run function bcsmp:factions/check_if_in/any_faction/cycle_uuid
#------------------------------------------#