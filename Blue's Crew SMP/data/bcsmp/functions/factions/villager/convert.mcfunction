...
data modify entity @s Offers.Recipes set value [{maxUses:1,buy:{id:"minecraft:emerald_block",Count:1b},sell:{id:"minecraft:paper",Count:1b,tag:{FactionPaper:1b,display:{Name:'{"text":"Enter Faction Name...","color":"white","italic":false}'}}}}]
