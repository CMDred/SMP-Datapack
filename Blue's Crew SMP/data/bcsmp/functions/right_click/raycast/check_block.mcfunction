...
execute if score #SearchFor Temp matches 2 if block ~ ~ ~ #minecraft:crops[age=7] run tag @s add HoesOnCrop
execute if score #SearchFor Temp matches 2 if block ~ ~ ~ #minecraft:crops[age=7] if entity @s[tag=!AimsAtRightBlockWithRightItem] run function bcsmp:right_click/raycast/raycast_enter_with_right_item
