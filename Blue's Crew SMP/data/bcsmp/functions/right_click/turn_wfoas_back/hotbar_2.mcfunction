...
data modify storage bcsmp:inventory OldItem set from storage bcsmp:inventory Inventory[{Slot:2b}]
...
item replace entity @s hotbar.2 from block 29999977 1 29832 container.0
