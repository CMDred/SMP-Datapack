...
data modify storage bcsmp:inventory OldItem set from storage bcsmp:inventory Inventory[{Slot:3b}]
function bcsmp:right_click/turn_wfoas_back/change_item
item replace entity @s hotbar.3 from block 29999977 1 29832 container.0
