...
data modify storage bcsmp:inventory OldItem set from storage bcsmp:inventory Inventory[{Slot:8b}]
...
item replace entity @s hotbar.8 from block 29999977 1 29832 container.0
