...
data modify storage bcsmp:inventory OldItem set from storage bcsmp:inventory Inventory[{Slot:13b}]
...
item replace entity @s inventory.4 from block 29999977 1 29832 container.0
